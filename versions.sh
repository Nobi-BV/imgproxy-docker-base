...
export LIBDE265_VERSION=1.1.1
export KVAZAAR_VERSION=2.3.2
export DAV1D_VERSION=1.5.4
# export RAV1E_VERSION=0.5.1
export AOM_VERSION=3.14.1
export LIBHEIF_VERSION=1.23.1
